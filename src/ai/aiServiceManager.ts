...
import { CursorDetector } from '../utils/cursorDetector';
import { CursorAIAdapter, AIAdapter } from './cursorAdapter';
...
export class AIServiceManager {
    private cursorDetector: CursorDetector;
    ...
    private isCursorEnvironment: boolean = false;
    ...
    constructor(
        ...
        this.cursorDetector = new CursorDetector(logger);
        this.providerSelector = new AIProviderSelector(configManager, logger);
    }
     ...
     * 显示 WebView 配置面板
     */
    private async showConfigPanel(): Promise<string | undefined> {
     ...
     * 初始化 Cursor AI
     */
    private async initializeCursorAI(chatCommandId?: string): Promise<void> {
        this.logger.info('Initializing Cursor AI adapter...');

        this.currentAdapter = new CursorAIAdapter(this.logger, chatCommandId);
    ...
    private async initializeDeepSeek(): Promise<void> {
        ...
        this.currentAdapter = new DeepSeekAdapter(apiKey, this.logger);
    ...
    private async initializeClaude(): Promise<void> {
        ...
        this.currentAdapter = new ClaudeAdapter(apiKey, this.logger);
    ...
    private async initializeOpenAI(): Promise<void> {
        ...
        this.currentAdapter = new OpenAIAdapter(apiKey, this.logger);
