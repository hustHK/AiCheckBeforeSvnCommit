...
export class AIConfigPanel {
    ...
    private static readonly viewType = 'svnAIConfig';
    ...
    private constructor(
        ...
        this.disposables.push(
            this.configManager.onConfigurationChanged(() => this.updateContent())
        );
    }
    ...
    public static createOrShow(
        ...
        AIConfigPanel.currentPanel = new AIConfigPanel(
            panel,
            configManager,
            logger,
            onProviderSelected
            ...
            case 'selectProvider':
                if (message.provider) {
                    ...
                    vscode.window.showInformationMessage(
                        `✅ AI 服务已切换为: ${this.getProviderDisplayName(message.provider)}`
                    );
                }
                break;
